...
parser.add_argument('--arch', default='resnet18', type=str, help='arch for prediction depth')
...
H, x_edges, y_edges = np.histogram2d(pd_test_split_avg - 1, pd_train_split_avg - 1, bins=10)# (np.linspace(0, 9, 50), np.linspace(0, 9, 50)))
plt.figure()
# H[H < 1e-7] = np.nan
H = H.T
